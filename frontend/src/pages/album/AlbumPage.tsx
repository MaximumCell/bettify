    ...
    <div className="h-full">
      <ScrollArea className="h-full">
        ...
        <div className="relative min-h-full ">
          {/* bg gradient */}
          <div
            className="absolute inset-0 bg-gradient-to-b from-[#5038a0]/80 via-zinc-900/80 to-zinc-900 pointer-events-none rounded-2xl"
            aria-hidden="true"
          />
          {/* content */}
          <div className="relative z-10 ">
            ...
            <div className="bg-black/20 backdrop-blur-sm">
              {/* table header */}
              <div className="grid grid-cols-[16px_4fr_2fr_1fr] gap-4 px-10 py-2 text-sm to-zinc-400 border-b border-white/5">
                <div>#</div>
                <div>Title</div>
